        ...
        <div class="card-body">
            ...
            if (isset ($_POST['submit'])) {
                ...
                if (!in_array($extension, $file_extension)) {
                    echo "<script>alert('File Tidak Didukung!'); window.location = 'dashboard.php?Halaman=tambah_berita'</script>";
                } else {
                    if ($size_foto_berita < 409600) {
                        ...
                        echo "<script>alert('Berita Berhasil di Tambahkan!'); window.location = 'dashboard.php?Halaman=berita'</script>";
                    } else {
                        echo "<script>alert('Ukuran Foto Terlalu Besar!'); window.location = 'dashboard.php?Halaman=tambah_berita'</script>";
                    }
                }
